...
- ***Vase-N***:  *N* agents are randomly distributed on the curve of Vase which is formed according to [<sup>[2]</sup>](#refer-vase).
...
- ***Arch-N***: *0.34N* and *0.63N* agents are randomly distributed on the curve of left and right 'archimedean spiral antenna' (abbr. 'Arch') respectively, and *0.03N* agents are designed to connect two Archs.
...
- [3] [Kaiser J. The Archimedean two-wire spiral antenna[J]. IRE Transactions on Antennas and Propagation, 1960, 8(3): 312-323.](https://ieeexplore.ieee.org/abstract/document/1144840)
